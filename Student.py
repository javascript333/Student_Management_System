...
class Student:
    def __init__(self, root):
        ...
        title=Label(self.root, text="Student Managemt System",bd=10,relief=GROOVE, font=("times new roman", 40, "bold"),bg="yellow",fg="red")
    ...
    #================Detail Frame==================================
        ...
        lbl_search=Label(Detail_Frame, text="Search_By",bg="crimson",fg="white",font=("times new roman",20,"bold"))
